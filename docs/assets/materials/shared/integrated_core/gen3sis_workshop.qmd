...
<img src="https://raw.githubusercontent.com/ohagen/DispDiv3/main/inst/logo/dispdiv3.png" style="width: 40%; ">
:::

Integrated course script for SoSe 2026  
Mechanistic Eco-Evolutionary Modelling block seminar  
Frankfurt, Germany  

::: {#right .flex-item style="flex: 1; display: flex; justify-content: center;"}
<img src="../../../images/day1/qr-code-workshop.jpg" style="width: 100px;">
Course QR code
:::
