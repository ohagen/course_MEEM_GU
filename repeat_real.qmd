...
landscape <- readRDS(here::here("data", "landscapes", "SouthAmerica", "landscapes.rds"))
...
SA_1 <- terra::rast(landscape$temp[ ,c("x", "y", "1")])
SA_65 <- terra::rast(landscape$temp[,c("x", "y", "65")])
...
config <- create_input_config(
  config_file = here::here("assets", "materials", "day1", "configs", "config_southamerica_Day1Prac1.R")
)
...
```{r eval=F}
sim <- run_simulation(config = here::here("assets", "materials", "day1", "configs", "config_southamerica_Day1Prac1.R"), 
               landscape = here::here("data", "landscapes", "SouthAmerica"),
               output_directory = here::here("output", "SouthAmerica"),
               verbose=1)
```
...
# read phylogeny
phy <- read.nexus(here::here("output", "SouthAmerica", "config_southamerica_Day1Prac1", "phy.nex"))
# 
# # plot phylogeny
...
```{r, eval=F}
file.edit(here::here("assets", "materials", "day1", "configs", "config_southamerica_Day1Prac1.R"))
```
