...
This course is designed to provide the basics on how to use gen3sis for various research questions, which is crucial for defining models within the modeling cycle. The course will briefly introduce the philosophical context of natural science and the principles of mechanistic models. 
...
The course mainly uses simulated data, leading to valuable insights about the interplay between processes and patterns in biodiversity research.
...
-   [Setup and the Basics](setup.qmd): Core setup, first simulation workflow, and troubleshooting foundations.
-   [Repeat for real](repeat_real.qmd): Practical with a more realistic South America paleo-landscape and discussion of temporal resolution.
-   [🏝️ Practical Island Hopping](prac_islands.qmd): Ground-up implementation of a full simulation workflow on an island system.
-   [🌋 Practical Creating Worlds](prac_landscapes.qmd): Landscape-focused practical with environment construction and resolution-aware design choices.
-   [🖥️ Practical Emergent Silicodiversity](prac_outputs.qmd): Output exploration, summary interpretation, and custom diagnostics for biodiversity patterns.
-   [🎲 Unified Neutral Theory of Biodiversity and Biogeography](prac_untbb.qmd): Integrated practical for custom hypothesis testing and model adaptation.
-   [Important considerations](considerations.qmd): Caveats, assumptions, and data constraints for critical interpretation.
-   [Further Resources](resources.qmd): Additional package docs, vignettes, prior workshops, and key reading links.
